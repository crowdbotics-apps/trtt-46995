"""
Django settings for trtt_46995 project.
...
WSGI_APPLICATION = 'trtt_46995.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trtt_46995 API",
    "DESCRIPTION": "API documentation for trtt_46995 App",
    "VERSION": "v1",
}
